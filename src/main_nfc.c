...
#define FLASH_APP_NFC_BASE   0xF5000
flash_t flash_nfc;

void nfc_event_listener(void *arg, unsigned int event) {
    DiagPrintf("NFC event\r\n");
    switch(event) {
...
unsigned int generate_default_tag_content() {
    DiagPrintf("generate_default_tag_content...\r\n");
...
void nfc_load_tag_content_from_flash() {
    DiagPrintf("nfc_load_tag_content_from_flash...\r\n");
...
void nfc_store_tag_content() {
    DiagPrintf("nfc_store_tag_content...\r\n");
    int i, address;
...
void main(void)
{
    ...
    xTaskCreate(nfc_task, ((const char*)"init"), 1024, NULL, tskIDLE_PRIORITY + 3 + PRIORITIE_OFFSET, NULL);
